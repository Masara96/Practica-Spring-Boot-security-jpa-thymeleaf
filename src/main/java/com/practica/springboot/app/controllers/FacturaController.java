...
import com.practica.springboot.app.models.entity.ItemFactura;
import com.practica.springboot.app.models.entity.Producto;
...
public class FacturaController {
	...
	public String borrar(@PathVariable(name = "id") Long id, RedirectAttributes flash) {
		...
		try {
			...
			if (factura == null) {
				flash.addFlashAttribute("error", "No existe la factura que se quiere borra");
				return "redirect:/listar";
			}
